  ...
  if self.isActif then
    love.graphics.print(Player.xVel)
      if Player.grounded then love.graphics.print('On Ground' , 0 , 10)
        else love.graphics.print('Flying', 0 , 10)
      end
      if camToPlayer then love.graphics.print('Watching Player',0,20)
      elseif not camToPlayer then love.graphics.print('Free' ,0 ,20) end
  end
end
